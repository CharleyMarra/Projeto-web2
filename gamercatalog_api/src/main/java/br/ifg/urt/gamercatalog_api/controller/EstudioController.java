...
public class EstudioController {
    ...
    @Operation(
        ...
        description = "Retorna os detalhes de um registro específico de estúdios através do seu id único.",
        responses = {
            @ApiResponse(description = "Sucesso", responseCode = "200",
                         content = @Content(schema = @Schema(implementation = EstudioResponseDTO.class))),
    ...
    @Operation(
        ...
        description = "Cadastra um novo registro de estúdios no sistema e retorna o objeto criado.",
        responses = {
    ...
    @Operation(
        ...
        description = "Atualiza todos os dados de um registro existente de estúdios.",
        responses = {
    ...
    @Operation(
        ...
        description = "Remove um registro de estúdios do sistema pelo seu ID.",
        responses = {
