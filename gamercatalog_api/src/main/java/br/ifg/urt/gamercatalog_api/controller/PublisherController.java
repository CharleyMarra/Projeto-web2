...
public class PublisherController {
    ...
    @Operation(
        ...
        description = "Retorna uma página de publishers. Permite filtrar por nome e utilizar paginação e ordenação com os parâmetros 'page', 'size' e 'sort'.",
        responses = {
    ...
    public ResponseEntity<Page<PublisherResponseDTO>> buscarTodos(
