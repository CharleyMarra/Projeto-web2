...
public class FavoritosController {
    ...
    @Operation(
        ...
        description = "Retorna uma lista com todos os registros de favoritos cadastrados.",
        responses = {
            @ApiResponse(description = "Sucesso", responseCode = "200",
                         content = @Content(schema = @Schema(implementation = FavoritosResponseDTO.class))),
    ...
    @Operation(
        ...
        description = "Retorna os detalhes de um registro específico de favoritos através do seu id único.",
        responses = {
            @ApiResponse(description = "Sucesso", responseCode = "200",
                         content = @Content(schema = @Schema(implementation = FavoritosResponseDTO.class))),
    ...
    @Operation(
        ...
        description = "Cadastra um novo registro de favoritos no sistema e retorna o objeto criado.",
        responses = {
    ...
    @Operation(
        ...
        description = "Remove um registro de favoritos do sistema pelo seu ID.",
        responses = {
